                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <div>
                            ...
                            <button className="inline-flex text-white bg-yellow-500 border-0 py-2 px-16 focus:outline-none hover:bg-gray-800 transition duration-300 rounded-full text-lg"><NavLink to="/services">EXPLORE OUR OFFERINGS</NavLink></button>
                        </div>
                    </div>
                </div>
            </section>
