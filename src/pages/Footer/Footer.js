                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            <h2 className="title-font text-yellow-400 font-medium tracking-widest text-sm mb-3">Our Branches</h2>
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-yellow-400 tracking-widest text-sm mb-3">Important Links</h2>
                            <nav className="list-none mb-10">
                                <li>
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            ...
                            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                                ...
                                <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-yellow-400 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-400 rounded">Subscribe</button>
                            </div>
